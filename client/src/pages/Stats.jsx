...
export default function Stats() {
  ...
  return (
    <div className="flex flex-col justify-center items-center animate-in fade-in duration-700 ">
      <p className="text-2xl font-bold	text-myblack">Statystyki</p>
      <br />
      <br />
      <br />
      {show ? (
        <div className="animate-in fade-in duration-700 ">
          <div className="flex flex-col justify-center gap-2 items-center ">
            ...
            <p><b>Najczęstszy samolot:</b> {stats.most_flight_aircraft[0].aircraft} ({stats.most_flight_aircraft[0].number_of_flights} razy)</p>
          </div>
        </div>
      ) :
        <div className="animate-out fade-out duration-300 delay-200">
          <div className="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
            <svg class="w-16 h-16 animate-spin text-gray-00" viewBox="0 0 64 64" fill="none"
              ...
              <path
                ...
                stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" class="text-[#131218]">
              </path>
            </svg>
          </div>
        </div>
